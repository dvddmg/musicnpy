...
\score {
	\new StaffGroup
		...
		\new Staff \with {
				 ...
				 <<
  				 { < c' ds' fs a' >2 < c' b' fs a' >2 < c' b' fs fs'' >2 < g' b' fs fs'' >2 < d' f gs' b' >2 < a' f gs' b' >2 < a' c' gs' b' >2 < a' c' e'' b' >2 < ds' fs' a c'' >2 < ds' fs' a a'' >2 < ds' fs' fs' a'' >2 < ds' d'' fs' a'' >2 < f' gs b' d'' >2 < f' e' b' d'' >2 < c'' e' b' d'' >2 < c'' e' b' b'' >2 < fs' a' c' ds'' >2 < d'' a' c' ds'' >2 < d'' fs'' c' ds'' >2 < d'' fs'' a' ds'' >2 < gs' b d'' f'' >2 < e'' b d'' f'' >2 < e'' b d'' d''' >2 < e'' g' d'' d''' >2 < a' c'' ds' fs'' >2 < f'' c'' ds' fs'' >2 < f'' gs'' ds' fs'' >2 < f'' gs'' ds' ds''' >2 < b' d' f'' gs'' >2 < b' d' f'' e''' >2 < b' d' cs''' e''' >2 < b' as' cs''' e''' >2 < c' ds' fs a' >2 < c' ds' d' a' >2 < c' b' d' a' >2 < c' b' d' fs'' >2  }
 				 >>
		}
		>>
